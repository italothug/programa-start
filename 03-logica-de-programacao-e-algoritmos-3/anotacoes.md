...
Exercicio 20. A concessionária de veículos “CARANGO VELHO” está vendendo os seus veículos com desconto. Faça
...
- Conceitos básicos para a criação de uma Interface Gráfica em JAVA utilizando SWING
  - Crianda uma tela
  ...
  - Exercicios (Criação de uma tela de login)

## 7.B

Criando primeira tela com interface

- 1 - Vc cria um projeto
- 2 - Botão direito no (Projeto.app > Source Packages[Java] > Projeto) > (New > JFrame Form)
- 3 - Vai aparecer um outro tipo de tela com as seguintes informações
  - Source : Código fonte da tela
  - Design : É a própria tela
    - [Preview Design](./imagens/preview-design.png) : Pré-visualização de como tá ficando a tela

## 7.C

Paleta de componentes

Ensinando como editar cada componente

## 7.D

Propriedades dos components básicos
